...
import yaml  # Import YAML library for reading and writing YAML files
import webbrowser  # Import webbrowser to open a web browser
...
def upload_parameter():
    global submitted_message  # Access the global variable
